...
const ROLE_LABELS = {
  convener_teacher: { zh: '召集老师 (Convener Teacher)', en: 'Convener Teacher' },
  advisor_teacher: { zh: '指导老师 (Advisor Teacher)', en: 'Advisor Teacher' },
  chairperson: { zh: '主席 (Chairperson)', en: 'Chairperson' },
  vice_chairperson: { zh: '副主席 (Vice Chairperson)', en: 'Vice Chairperson' },
  secretary: { zh: '正文书 (Secretary)', en: 'Secretary' },
  vice_secretary: { zh: '副文书 (Vice Secretary)', en: 'Vice Secretary' },
  treasurer: { zh: '正财政 (Treasurer)', en: 'Treasurer' },
  vice_treasurer: { zh: '副财政 (Vice Treasurer)', en: 'Vice Treasurer' },
  general_affairs: { zh: '正总务 (General Affairs)', en: 'General Affairs' },
  vice_general_affairs: { zh: '副总务 (Vice General Affairs)', en: 'Vice General Affairs' },
  activity_lead: { zh: '活动组组长 (Activity Lead)', en: 'Activity Lead' },
  vice_activity_lead: { zh: '活动组副组长 (Vice Activity Lead)', en: 'Vice Activity Lead' },
  activity_member: { zh: '活动组组员 (Activity Member)', en: 'Activity Member' },
  media_lead: { zh: '正摄影 (Photographer)', en: 'Photographer' },
  vice_media_lead: { zh: '副摄影 (Vice Photographer)', en: 'Vice Photographer' },
  ordinary_member: { zh: '普通会员 (Ordinary Member)', en: 'Ordinary Member' },
  custom: { zh: '自定义 (Custom)', en: 'Custom' },
  advisor: { zh: '指导老师 (Advisor Teacher)', en: 'Advisor Teacher' },
  committee: { zh: '自定义 (Custom)', en: 'Custom' },
  event_member: { zh: '活动组组员 (Activity Member)', en: 'Activity Member' }
}
...
const T = {
  zh: {
    title: '⚙️ 个人设置',
    subtitle: 'Account Settings · 管理你的账号信息与通知偏好',
    info_title: '账号信息 Account Info',
    lbl_name: '姓名 Name',
    lbl_email: '电子邮箱 Email',
    lbl_role: '系统角色 Role',
    lbl_status: '账号状态 Status',
    lbl_status_active: '✅ 使用中 Active',
    lbl_status_inactive: '❌ 已停用 Deactivated',
    lbl_admin_note: '如需修改姓名或角色，请联系主席或顾问老师。',

    pw_title: '修改密码 Change Password',
    ...
    lbl_pw_current: '当前密码 Current Password',
    lbl_pw_new: '新密码 New Password',
    lbl_pw_confirm: '确认新密码 Confirm New Password',
    pw_note: '密码至少 6 位。修改后需重新登录。',
    pw_btn_saving: '更新中...',
    pw_btn_save: '确认修改密码',

    notif_title: '推送通知 Push Notifications',
    notif_desc: '开启后，任务截止提醒将推送到你的设备。',
    notif_status_lbl: '当前通知权限',
    notif_status_desc: 'Browser notification permission status',
    notif_badge_enabled: '已开启 Enabled',
    notif_badge_denied: '已拒绝 Denied',
    notif_badge_notset: '未设置 Not Set',
    notif_badge_unsupported: '不支持 Unsupported',
  ...
  en: {
    ...
    lbl_admin_note: 'To change your name or role, please contact the Chairperson or Advisor Teacher.',
